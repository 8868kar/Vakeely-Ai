...
import { FiUser, FiMail, FiLock, FiPhone, FiEye, FiEyeOff, FiMapPin, FiBriefcase } from 'react-icons/fi';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (accountType === 'lawyer') {
        payload.experience = parseInt(payload.experience) || 0;
        payload.consultationFee = parseInt(payload.consultationFee) || 500;
      }
