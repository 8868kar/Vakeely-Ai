...
import { lawyerAPI, appointmentAPI } from '../services/api.js';
import { useAuth } from '../context/AuthContext.js';
import { FiStar, FiMapPin, FiBriefcase, FiDollarSign, FiAward, FiCalendar, FiX, FiAlertTriangle } from 'react-icons/fi';
...
const LawyerProfilePage: React.FC = () => {
  ...
  const [bookingData, setBookingData] = useState<BookingData>({ date: '', time: '', caseType: '', description: '' });
  ...
  const fetchLawyer = async () => {
    try {
      const res = await lawyerAPI.getById(id as string);
      setLawyer(res.data);
    } catch (err) {
